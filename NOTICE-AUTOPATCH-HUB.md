...
Principal modifications include a pinned-key signed update manifest,
anti-rollback sequence, SDK/ABI artifact selection, Manager and MicroG-RE
pre-download/verification, automatic compatible installed-YouTube selection,
WorkManager-only notifications, a unified in-app update center, and independent
GitHub Actions release automation.

The original [NOTICE](NOTICE) and GPL-3.0-or-later license remain in force.
